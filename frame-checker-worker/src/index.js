...
// 옮겼다(docs/TESTING.md 참고). listQueuedReasonLeaveDays는
// buildPersonalStatus(개인 대시보드, 이 파일 잔류)가 실사용하고,
// flushQueuedReasonLeaveProofs는 handleBotRegisterUrl(봇 도메인, 이 파일
// 잔류)이 실사용한다 — 둘 다 재export가 아니라 9~10차와 동일한 실사용
// import 패턴이라 새로운 위험이 없다.
import {
  handleGetLeaveApply,
  handleSetLeaveApply,
  handleAdminLeaveApply,
  handleGetReasonLeaveProof,
  listQueuedReasonLeaveDays,
  handleSetReasonLeaveProof,
  handleCancelReasonLeaveProof,
  flushQueuedReasonLeaveProofs,
